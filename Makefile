...
NONVM_VARIANTS = non-vm-baseline non-vm-unroll non-vm-pipeline non-vm-pipeline_unroll non-vm-asm

all: baseline neon asm pipeline

non-vm: non-vm-baseline non-vm-unroll non-vm-pipeline non-vm-pipeline_unroll non-vm-asm
...
clean:
	rm -f baseline unroll neon asm pipeline non-vm-baseline non-vm-unroll non-vm-pipeline non-vm-pipeline_unroll non-vm-asm
